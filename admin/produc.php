...
/*Verificar que no comparta nombre con otro producto y que la imagen no sea muy grande antes de añadir un producto*/
  if($select_products->rowCount() > 0){
     $message[] = 'Ya hay otro producto con ese nombre';
  }else{
...
if(isset($_GET['delete'])){
  ...
  unlink('../subir_img/'.$fetch_delete_image['image_01']);
  unlink('../subir_img/'.$fetch_delete_image['image_02']);
  unlink('../subir_img/'.$fetch_delete_image['image_03']);
...
<!-- Nombre, precio, imagenes y detalles del producto -->
   <form action="" method="post" enctype="multipart/form-data">
      <div class="flex">
         <div class="inputBox">
            <span>Nombre del producto (requerido)</span>
            <input type="text" class="box" required maxlength="100" placeholder="Digite nombre" name="name">
         </div>
         <div class="inputBox">
            <span>Precio (requerido)</span>
            <input type="number" min="0" class="box" required max="9999999999" placeholder="Digite precio" onkeypress="if(this.value.length == 10) return false;" name="price">
         </div>
        <div class="inputBox">
        ...
        <div class="inputBox">
         ...
         <div class="inputBox">
            ...
            <textarea name="details" placeholder="Describa el producto" class="box" required maxlength="500" cols="30" rows="10"></textarea>
         </div>
      </div>
